...
#primero correr el db_setup
#segundo correr el main.py
#tercero ingresar al aplicativo, ruta para visualizar el aplicativo en local una vez este corriendo http://127.0.0.1:5000/
